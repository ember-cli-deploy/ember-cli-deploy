...
module.exports = CoreObject.extend({
  init: function(project, ui, config) {
    ...
    if (this._isUsingOldPluginControl()) {
      if (this._isUsingNewPluginControl()) {
        ...
        ui.writeError('See the following pages for information:\n');
        ui.writeError('http://ember-cli-deploy.com/docs/v0.6.x/aliasing-plugins/');
        ui.writeError('http://ember-cli-deploy.com/docs/v0.6.x/disabling-plugins/');
        ui.writeError('http://ember-cli-deploy.com/docs/v0.6.x/plugin-run-order/\n');
      }
    }
  },
  ...
  plugins: function() {
    ...
    var addons = this._registry._validAddons(allEmberCliAddons);

  ...
  setup: function(){
    ...
    return this._readDeployConfig().then(function(deployConfig){
      ...
      if (pluginNames.length === 0) {
        ...
        self.ui.writeError("ember-cli-deploy works by registering plugins in it's pipeline.");
        self.ui.writeError("In order to execute a deployment you must install at least one ember-cli-deploy compatible plugin.\n");
        self.ui.writeError("Visit http://ember-cli.github.io/ember-cli-deploy/plugins for a list of supported plugins.\n");
      }

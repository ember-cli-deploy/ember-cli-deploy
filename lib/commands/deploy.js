...
module.exports = {
  ...
  availableOptions: [
    ...
    { name: 'dry-run', type: Boolean, description: '(Default: false)'}
  ],
  ...
  run: function(commandOptions, rawArgs) {
    ...
    commandOptions.dryRun = chooseOptionValue(commandOptions.dryRun, this.settings, 'dry-run', false);

    this.ui.verbose = commandOptions.dryRun || chooseOptionValue(commandOptions.verbose, this.settings, 'verbose');
    ...
    this.ui.logInfoColor = chooseOptionValue(commandOptions.logInfoColor, this.settings, 'logInfoColor', commandOptions.dryRun ? 'yellow' : 'blue');

...
The following plugins have been developed by community members:
  ...
  - [ember-cli-deploy-git](https://github.com/ef4/ember-cli-deploy-git) - deploy your built application to a git branch
  ...
  - [ember-cli-deploy-minio](https://github.com/trustvox/ember-cli-deploy-minio) - deploy assets to Minio storage

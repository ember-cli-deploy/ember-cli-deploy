...
The following plugins have been developed by community members:
  ...
  - [ember-cli-deploy-build-plus](https://github.com/martinic/ember-cli-deploy-build-plus) - build your app using distDir as input and output
...
Anyone needing assistance in porting a 0.4.x custom adapter to a 0.5.x plugin can [open an issue on the ember-cli-deploy Github repository](https://github.com/ember-cli-deploy/ember-cli-deploy/issues) and we'll be happy to help.

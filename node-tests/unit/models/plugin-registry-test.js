...
describe('Plugin Registry', function() {
  ...
  it('warns if no plugins are installed', function() {
    ...
    expect(logOutput[3]).to.eq('Visit http://ember-cli-deploy.github.io/ember-cli-deploy/docs/v0.6.x/plugins/ for a list of supported plugins.');
  });
  ...
  describe('specifying disabled plugins', function() {
    it('returns only plugins that are not disabled', function() {
      var project = makeProject(['foo', 'bar']);
